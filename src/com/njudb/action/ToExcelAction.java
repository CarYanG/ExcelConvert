...
public class ToExcelAction implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (MainGUI.filepath.getText()=="" ||MainGUI.filepath.equals(null)){
			Toolkit.getDefaultToolkit().beep();
			JOptionPane.showMessageDialog(null, "未导入文件", 
					"错误",JOptionPane.INFORMATION_MESSAGE);
		}
		else{
			String inputFilePath=MainGUI.filepath.getText().substring(5);
